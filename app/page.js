          ...
          <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2} bgcolor="white" p={2} borderRadius="10px">
            ...
            <Stack direction="row" spacing={2}>
              ...
              <Button
                ...
                sx={{ borderRadius: "10px", bgcolor: "f0f0f0", color: "white" }}
              >
                Clear All Items
              </Button>
            </Stack>
        ...
        <Box border="2px solid #E6F2FF" borderRadius="10px" width="300px" p={3} bgcolor="#E6F2FF">
          ...
          <Box bgcolor="white" borderRadius="10px" p={2} height="630px" overflow="auto">
            {inventory.map(({ name, quantity }) => (
              <Box key={name} display="flex" justifyContent="space-between" alignItems="center" mb={2} p={1} bgcolor="#F0F8FF" borderRadius="5px">
          ...
          <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2} bgcolor="white" p={2} borderRadius="10px">
            ...
            <Stack direction="row" spacing={2}>
              ...
              <Button
                variant="contained"
                onClick={clearAllItems}
                sx={{ borderRadius: "10px", bgcolor: "#F44336", color: "white" }}
              >
                Clear All Items
              </Button>
            </Stack>
